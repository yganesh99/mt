...
var JEELIZGLANCETRACKER = (function () {
				...
				D = {
					...
					s: function (r) {
						...
						r.Gc &&
							...
							((A = r.Gc),
							l.addEventListener('webglcontextlost', A, !1));
			...
			var t = 0,
				...
				k = {
					...
					Kd: function () {
						if (!x) {
							for (
								var d = new Float32Array(16384), F = 0;
								16384 > F;
								++F
							)
								d[F] = 2 * Math.random() - 1;
					...
					instance: function (d) {
						...
						function M() {
							Q =
								void 0 !== z.B.videoWidth
									? z.B.videoWidth
									: z.B.width;
							R =
								void 0 !== z.B.videoHeight
									? z.B.videoHeight
									: z.B.height;
						}
						function O(G) {
						...
						var Oa = (F = null);
						z.width &&
							((Q = z.width), (R = z.height ? z.height : Q));
						var Y = {
							get: function () {
								return fa;
							},
				...
				q = {
					...
					instance: function (n) {
						...
						var J = {
							gd: function (I) {
								l !== p &&
									(a.bindBuffer(a.ARRAY_BUFFER, u), (l = p));
								I && Ha.Nb();
							},
							dd: function () {
								t !== p &&
					...
					Ha: function () {
						-1 !== l &&
							(a.bindBuffer(a.ARRAY_BUFFER, e.R), (l = -1));
						-1 !== t &&
							(a.bindBuffer(a.ELEMENT_ARRAY_BUFFER, e.indices),
							(t = -1));
					},
					l: function (n, p) {
						n && W.Ha();
				...
				t = {
					...
					s: function () {
						if (!m) {
							...
							var q = N.Y();
							e =
								q && a.DRAW_FRAMEBUFFER
									? a.DRAW_FRAMEBUFFER
									: a.FRAMEBUFFER;
							c =
								q && a.READ_FRAMEBUFFER
									? a.READ_FRAMEBUFFER
									: a.FRAMEBUFFER;
							m = !0;
						}
					...
					instance: function (q) {
						...
						var g = {
							...
							bind: function (J, I) {
								B !== l.C &&
									(a.bindFramebuffer(e, A), (l.C = B));
								n && n.o();
								I && a.viewport(0, 0, p, x);
								J &&
									a.clear(
										a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT
									);
							},
							Pe: function () {
								B !== l.C &&
			...
			var q = null,
				...
				I = {
					...
					Yc: function (f) {
						...
						!f &&
							g.ja &&
							(l(), a.bindBuffer(g.M, null), (g.ja = !1));
					},
					Hf: function () {
						return g.ja;
					},
		...
		Ya = {
			instance: function (b) {
				var e = null,
					...
					q = null,
					n =
						'undefined' === typeof b.preprocessing
							? !1
							: b.preprocessing,
					p =
			...
			instance: function (b) {
				...
				var v = {
					...
					od: function (E) {
						...
						E =
							'undefined' !== typeof b.classesCount &&
							b.classesCount
								? b.classesCount
								: b.size * b.size;
	...
	var Za = {
				...
				return {
					...
					J: function (m) {
						if (m.isEnabled) {
							...
							m.Yd.g(3);
							for (
								var y = Math.min(m.Ua.length, m.depth), l = 0;
								l < y;
								++l
							)
								m.Ua[l].ed(4 + l);
		...
		$a = {
			instance: function (b) {
				...
				D = Math.floor(m / 2);
				for (
					var r = 0.5 / c, B = 0.5 / e, g = 0.5 / y, J = 0;
					J < c;
					++J
				)
	...
	function jb() {
		...
		return -1 !== b.indexOf('safari') && -1 === b.indexOf('chrome')
			? !0
			: !1;
	}
	function kb() {
	...
	function lb(b) {
		...
		if (b.video) {
			...
			e = {};
			'undefined' !== typeof b.video.width &&
				(e.width = c(b.video.width));
			'undefined' !== typeof b.video.height &&
				(e.height = c(b.video.height));
			...
			if (b.video.width.ideal && b.video.height.ideal) {
				...
				for (q.ca = void 0; n < l.length; q = { ca: q.ca }, ++n) {
					...
					for (p.ba = void 0; x < t.length; p = { ba: p.ba }, ++x)
						if (
							((p.ba = t[x]),
							q.ca !== b.video.width.ideal ||
								p.ba !== b.video.height.ideal)
						) {
		...
		navigator.mediaDevices
			...
			.then(function (t) {
				...
				'undefined' !== typeof b.srcObject
					? (b.srcObject = t)
					: ((b.src = window.URL.createObjectURL(t)),
					  (b.videoStream = t));
				qb(b);
	...
	var ub = (function () {
			...
			function l() {
				...
				K.timeout &&
					(window.clearTimeout(K.timeout), (K.timeout = null));
			}
			function t(w) {
				w && !f.O
					? ((f.O = !0),
				...
				L = {
					s: function (w) {
						...
						if (null !== D.Vb) {
							...
							var h = { antialias: !1 };
							w =
								w.getContext('webgl2', h) ||
								w.getContext('webgl', h);
							if (
								(h =
									w.getExtension(
		...
		vb = (function () {
			...
			return {
				...
				Lf: function (A) {
					A >= t.length ||
						(t[A] = Math.floor(Math.random() * n.length));
				},
				Rf: function (A) {
					p = A;
					if (0 === p) n = m;
			...
			w = {
				...
				Wd: function (h) {
					return new Promise(function (k) {
						...
						u = X.Je.slice(0);
						d.exportData &&
							(u = d.exportData.translationScalingFactors || u);
						u[0] *= X.$[0];
						u[1] *= X.$[1];
						u[2] *= X.$[2];
	...
	var yb = {
		...
		init: function (b) {
			...
			yb.ha = xb({
				Qd:
					'undefined' === typeof b.isDisplayVideo
						? !0
						: b.isDisplayVideo,
				hd: function (c, m) {
